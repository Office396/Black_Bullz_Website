        ...
        <div className="max-w-full mx-auto px-4 lg:px-6 py-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-[#0f1d32] border border-[#1e3050] rounded-xl p-6 text-center">
            ...
            <div className="bg-[#0f1d32] border border-[#1e3050] rounded-xl p-8 mb-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                <Shield className="w-6 h-6 text-[#00bcd4]" />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link href="/signup" className="w-full sm:w-auto">
                  <Button className="w-full bg-[#00bcd4] hover:bg-[#0097a7] text-white">
                    Create Account
