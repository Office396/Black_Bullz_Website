            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                {collections.map((collection) => (
                    <Link
                        ...
                        className="group"
                    >
                        <div className="relative bg-gradient-to-br from-[#1a2a44] to-[#0f1d32] border border-[#1e3050] rounded-xl p-4 hover:border-[#00bcd4]/50 transition-all duration-300 hover:scale-[1.02]">
                            <div className="relative w-full aspect-square mb-3 rounded-lg overflow-hidden">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                    <div className="bg-[#00bcd4]/90 text-white px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                                        Explore <ChevronRight className="w-3 h-3" />
                                    </div>
                                </div>
                            </div>
                            <h3 className="text-white font-medium text-sm line-clamp-2 group-hover:text-[#00bcd4] transition-colors text-center">
                                {collection.name}
                            </h3>
