  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="flex items-center gap-2 text-sm text-gray-400">
        ...
        <Link href="/games" className="hover:text-[#00bcd4] transition-colors">Games</Link>
        <ChevronLeft className="w-4 h-4 rotate-180" />
        <span className="text-white">{game.title}</span>
      </nav>

      {/* Hero Section */}
      <div className="bg-gradient-to-br from-[#1a2a44] to-[#0f1d32] border border-[#1e3050] rounded-2xl overflow-hidden">
        <div className="flex flex-col lg:flex-row gap-6 p-6 lg:p-8">
          ...
          <div className="flex-1 space-y-4">
            ...
            {/* Meta Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 py-4 border-y border-[#1e3050]">
              <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white font-medium">{game.uploader || 'BlackBullz Team'}</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href={`/game/${game.id}?action=download`} className="flex-1 sm:flex-initial">
                <Button className="w-full sm:w-auto bg-[#00bcd4] hover:bg-[#0097a7] text-white font-semibold px-8 py-6 text-lg">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-[#00bcd4] hover:underline text-sm"
            >
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-[#0f1d32] border border-[#1e3050] rounded-xl p-4 text-center">
      ...
      {/* Description */}
      <Card className="bg-[#0f1d32] border border-[#1e3050]">
        ...
        <div className="flex flex-wrap gap-2">
          {genres.map((genre) => (
            <Link key={genre} href={`/genre/${genre.toLowerCase().replace(/ /g, '-')}`}>
              <Badge className="bg-white/5 hover:bg-white/10 text-gray-300 border border-white/10 cursor-pointer transition-colors">
                {genre}
              </Badge>
            </Link>
          ))}
      ...
      <Card className="bg-[#0f1d32] border border-[#1e3050]">
        <CardHeader>
          <CardTitle className="text-white">{game.title} Free Download - Game Review</CardTitle>
        </CardHeader>
        <CardContent>
