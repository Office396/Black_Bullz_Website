      ...
      <div className="relative rounded-2xl overflow-hidden keep-white">
        ...
        <div className="relative w-full lg:w-72 flex-shrink-0">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            <Button
              variant="outline"
              className="h-9 px-3 border-gray-300 dark:border-white/20 text-gray-700 dark:text-white hover:bg-red-500/10 hover:text-red-600 dark:hover:text-red-400 hover:border-red-500/30"
        ...
        <div className="flex-1 space-y-4">
          ...
          {/* Meta Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-5 py-4 border-y border-gray-200 dark:border-white/20">
            {game.developer && (
              <div>
                <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400 text-xs font-bold uppercase tracking-widest mb-1.5">
                  <User className="w-4 h-4" />Developer
                </div>
                <p className="text-gray-900 dark:text-white text-sm font-medium">{game.developer}</p>
              </div>
            )}
            {(game as any).publisher && (
              <div>
                ...
                <Link href={`/publishers/${(game as any).publisher.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-base font-bold transition-all hover:scale-[1.02]"
                  style={{ background: "rgba(157,78,221,0.2)", border: "1px solid rgba(157,78,221,0.5)", color: "#c77dff" }}>
            ...
            {game.size && (
              <div>
                ...
                <p className="text-gray-900 dark:text-white text-sm font-medium">{game.size}</p>
              </div>
            )}
            {game.releaseDate && (
              <div>
                ...
                <p className="text-gray-900 dark:text-white text-sm font-medium">{new Date(game.releaseDate).getFullYear()}</p>
              </div>
            )}
            <div>
              <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400 text-xs font-bold uppercase tracking-widest mb-1.5">
