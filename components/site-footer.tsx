    ...
    return (
        <footer className="bg-[#060e1a] border-t border-[#1e3050] mt-12">
            <div className="max-w-[1400px] mx-auto px-4 lg:px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5">
                            ...
                            <li><Link href="/games?category=pre-installed" className="text-gray-400 hover:text-[#00bcd4] text-sm transition-colors">Pre-installed PC Games</Link></li>
                            <li><Link href="/games?category=installable" className="text-gray-400 hover:text-[#00bcd4] text-sm transition-colors">Installable PC Games</Link></li>
                            <li><Link href="/games?category=android-mod" className="text-gray-400 hover:text-[#00bcd4] text-sm transition-colors">Android Mod APKs</Link></li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-[#1e3050] mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
